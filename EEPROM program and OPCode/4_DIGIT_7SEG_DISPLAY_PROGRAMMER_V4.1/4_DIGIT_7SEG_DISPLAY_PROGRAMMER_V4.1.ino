 ...
 * Version 4.1 - WRITING DATA TO EEPROM  - Common Anode Mode - Two's Complement Notation - Digits from Left to right
...
void BCD(int num){
  ...
  int negativeNum= ~num; // 1's Complement
  ...
  /* Negative Numbers */
  num = temp+1;
  setAdd(negativeNum); // Set constant Address
  k = 1;
